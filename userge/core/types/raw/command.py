            ...
            incoming_flt = filters.create(
                ...
                and ((m.from_user.id in Config.OWNER_ID)
                     or (Config.SUDO_ENABLED and (m.from_user.id in Config.SUDO_USERS)
                         ...
                         or (Config.SUDO_ENABLED and ((m.from_user.id in (Config.TRUSTED_SUDO_USERS and Config.TSUDO)) or (m.from_user.id in Config.TRUSTED_SUDO_USERS and m.from_user.id not in Config.TSUDO and cname.lstrip(trigger) in Config.TSUDO_CMD))))
