...
async def true_c_(message: Message):
    ...
    if not num.startswith("+"):
        await message.edit("Provide number in <b><u>international</u></b> format...", del_in=5)
        return
    ...
    async with userge.conversation(bot) as conv:
        try:
            ...
            await message.edit("Please unblock <code>@RespawnRobot</code> and try again...", del_in=5)
            return
